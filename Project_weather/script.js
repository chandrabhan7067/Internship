...
function guide(){
    alert("If you want to see weather report of any city then simply typ on the search bar which is in the top right corner and then click on search button or press enter then you will the result")
}
